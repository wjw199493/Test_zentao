...
class Excel_dx():
    ...
    def du (self,h,l):
        path = r'F:\untitled\我的坚果云\练习\zentao\case.xls'
    ...
    def xg(self,h,l,vale):
        ...
        #style = xlwt.XFStyle()
        read_file = xlrd.open_workbook(r'F:\untitled\我的坚果云\练习\zentao\case.xls', formatting_info=True)
        # 参数注释：
        ...
        # 保存写入数据后的文件到原文件路径
        write_data.save(r'F:\untitled\我的坚果云\练习\zentao\case.xls')
